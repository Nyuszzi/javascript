...
const helperImage = (image) => {
    let newFigure = document.createElement("figure");
    let newimage = document.createElement("img");
    newimage.setAttribute("src", image.image);
    newimage.setAttribute("alt", "frog backpack");
    let newFigcaption = document.createElement("figcaption");
    newFigcaption.innerText = image.description;
    newFigure.append(newimage, newFigcaption);
    return newFigure;
}

const createNewArticle = (content) => {
    let newArticle = document.createElement("article");
    newArticle.innerHTML = content;
    newArticle.append(helperImage(frogpack))
    return newArticle;
};

document.querySelector("main").append(createNewArticle(content))
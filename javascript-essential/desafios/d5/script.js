...
const backpackMap = backpackObjectArray.map((backpack) => {
  let mapArticle = document.createElement("article");
  mapArticle.classList.add("backpack");
  mapArticle.setAttribute("id", backpack.id);
